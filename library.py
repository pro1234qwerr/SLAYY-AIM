...
def AIMr(q, text, indent):
    if q:
        ...
        printable = (Fore.MAGENTA + "[SLAYY AIM] " + Style.RESET_ALL + Style.DIM + text + Style.RESET_ALL)
    if indent:
        printable = printable + "\n"
    return printable
...
def clearfig():
    ...
    result = pyfiglet.figlet_format("S L A Y Y", font="larry3d")
    print("\u001b[35m" + result.rstrip() + "\u001b[0m \n")
    print(AIMr(False, "Welcome to SLAYY AIM [" +  local_version + "]", False))
    print(AIMr(False, "Join the discord: https://discord.gg/z68jNsnVYk", True))
